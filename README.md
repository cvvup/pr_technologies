...
![Результат выполнения команды git add .](./images/image2.png)
...
![Ура, у нас есть первый коммит](./images/image3.png)

## Добавляем новый репозиторий

![Созданный репозиторий со всей необходимой структурой](./images/image3.png)
...
![Команда git push](./images/image4.png)
